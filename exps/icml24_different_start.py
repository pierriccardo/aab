...
fig.tight_layout()
fig.savefig(
    f"{SAVEPATH}/different_start_metrics.{EXT}",
    bbox_inches="tight",
    pad_inches=0.05,
    orientation="landscape",
)
tkz.save(
    f"{SAVEPATHTEX}/different_start_metrics.tex",
...
fig.tight_layout()
fig.savefig(
    f"{SAVEPATH}/different_start_armpull.{EXT}",
    bbox_inches="tight",
    pad_inches=0.05,
    orientation="landscape",
)
tkz.save(
    f"{SAVEPATHTEX}/different_start_armpull.tex",
    extra_tikzpicture_parameters=EXTRA_TIKZ_PARAM,
)
