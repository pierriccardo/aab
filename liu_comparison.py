...
ax2.plot(x, np.mean(np.cumsum(ace_egl_experiments_rewards, axis=1), axis=0),color=ACE_EGL_COLOR, label=ACE_EGL_LABEL)
ax2.plot(x, np.mean(np.cumsum(ace_ucb_experiments_rewards, axis=1), axis=0),color=ACE_UCB_COLOR, label=ACE_UCB_LABEL)
...
ax3.plot(x, np.mean(np.cumsum(ace_egl_experiments_attacks, axis=1), axis=0),color=ACE_EGL_COLOR, label='attack cost on e-greedy')
ax3.plot(x, np.mean(np.cumsum(ace_ucb_experiments_attacks, axis=1), axis=0),color=ACE_UCB_COLOR, label='attack cost on UCB')
ax3.legend()
